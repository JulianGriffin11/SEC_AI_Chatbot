...
# ⚡ SWAPPED: Swapping Docling for an Intel-compatible HTML-to-Markdown parser
...
def convert_downloads_to_markdown() -> dict:
    ...
    for filing in filings:
        ...
        # Pull down tables using the project's native layout parser tool
        ...
        if SKIP_EXISTING and md_path.exists():
            ...
            print(f"Converting {html_relative} using native engines...")
            
            # ⚡ FIXED: Clean conversion using markdownify tool wrapper instead of Docling
